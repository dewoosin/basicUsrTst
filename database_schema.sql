...
-- 캐시 관련 메시지
('CACHE_001', '04', '공통코드 캐시 초기화 실패', '공통코드 캐시 초기화에 실패했습니다.', '공통코드 캐시 초기화 실패'),
('CACHE_002', '04', '메시지 코드 캐시 초기화 실패', '메시지 코드 캐시 초기화에 실패했습니다.', '메시지 코드 캐시 초기화 실패'),
('CACHE_003', '04', '전체 캐시 초기화 실패', '전체 캐시 초기화에 실패했습니다.', '전체 캐시 초기화 실패'),
